...
function init() {
    ...
    */
    ...
    It also does not make sense to create individual variables for all the values. Stick that shit
    ...
    */
    ...
    function getPersonalInfoData() {
        ...
        data.address = {
            line1: getVal('input[name="address.line1"]'),
            line2: getVal('input[name="address.line2"]'),
            city: getVal('input[name="address.city"]'),
            state: getVal('input[name="address.state"]'),
            zip: getVal('input[name="address.zip"]')
        };
