...
*/
	...
	themiddleName = $form.find("input[name='middleName']").val(),
	thelastName = $form.find("input[name='lastName']").val(),
	thepreferredName = $form.find("input[name='preferredName']").val(),
	...
	thefbo_help = $form.find("input[name='fbo-help']").val(),
	...
	** NEW FIELDS FOR DATABASE/changes to make?
		...
		thefbo-help - bool - whether they think the fbo will provide help
